...
class ContributionsGraphContainer extends React.Component {
  ...
  setActiveTab(tab){
    ...
    renderTabs(candidateCampaigns) {
        ...
        const ids = flatten([...candidates.map((can) => {
                    ...
                    <Tab id="keshif"  eventKey={1} title={vizTitle} onEntered={() => this.setActiveTab('visualizer')}>
                        <div className="campaign-visualizer" >
                            <iframe
                                ...
                                src={'http://adilyalcin.me/campaign-finance-explorer/index.html?' + ids}>
                            </iframe>
                            <button
                                className="btn btn-info btn-xs"
                                onClick={() => this.goFullScreen('')}
                                style={{padding: '0', paddingLeft: '2px',  paddingRight: '2px', position: 'fixed', top: '2px', right: '10px', zIndex: 999999}}>
