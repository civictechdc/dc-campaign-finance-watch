    ...
    return (
      <div>
        <Row>
          <Col xs={12}>
            <ButtonGroup>
              <Button onClick={this.handleYearPreset.bind(this)}>
                {' '}Last Year{' '}
              </Button>
              <Button onClick={this.handleTwoYearsPreset.bind(this)}>
                {' '}Last 2 Years{' '}
              </Button>
              <Button onClick={this.handleTenYearsPreset.bind(this)}>
                {' '}Last 10 Years{' '}
              </Button>
            </ButtonGroup>
          </Col>
            ...
            <Row>
              <Col className="show-grid" xs={6}>
                ...
                <DayPicker
                  ...
                  modifiers={{
                    selected: day =>
                      DateUtils.isSameDay(this.state.startDate.toDate(), day)
                  }}
                />
              </Col>
              <Col className="show-grid" xs={6}>
                ...
                <DayPicker
                  ...
                  modifiers={{
                    selected: day =>
                      DateUtils.isSameDay(this.state.endDate.toDate(), day)
                  }}
                />
              </Col>
            </Row>
