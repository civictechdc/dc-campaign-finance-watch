            ...
            <div className="col-xs-9">
              ...
              <ol>
                <li className="instruction-item">
                  To search for specific types of campaigns
                  ...
                  To search races by candidate name, click on the "Search by candidate name" tab.
                </li>
                <li className="instruction-item">
                  Select one or more of the races shown in the search results.
                  You can view and edit these selections under the "Selections" tab (which will appear
                  to the left of the "Search by candidate" tab after you choose search terms).
                </li>
                <li className="instruction-item">
                  To view data for the selected races, click on the "Go" button (which will appear in the upper right-hand corner of the page after you've selected a race).
                  You will be taken to a page with:
                </li>
                <ul>
                  <li>
                    Data and graphs about the amount of money raised for each race
                  </li>
                  <li>
                    Information about the origin of each selected race's funds.
                  </li>
              ...
              {_.isEmpty(candidates)
                ...
                : <Link to={locationDescriptor}>
                    <Button bsStyle="primary" bsSize="large">
                      Go<i className="fa fa-search-plus" />
                    </Button>
                  </Link>}
            </div>
          </div>
          <div className="row">
            <div className="col-sm-12">
              ...
              >
                <Tab
                  eventKey={1}
                  title="Search By Year and Race"
                  tabClassName="search-tab"
                >
                  <RaceSearch
                    selections={candidates}
                    handleCampaignSelection={this._handleCampaignSelection.bind(
                      this
                    )}
                  />
                </Tab>
                <Tab
                  tabClassName="search-tab"
                  eventKey={2}
                  title="Search by candidate name"
                >
