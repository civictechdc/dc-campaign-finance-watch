...
class Dashboard extends React.Component {
  ...
  _loadPanelHeader(campaignData, campaignID, candidateName) {
    if (campaignData[campaignID] !== undefined) {
      let candidateScore = campaignData[campaignID]['campaigns'][0]['scores'][
        'total'
      ].toFixed(2);
        ...
        <Col xs={12}>
          ...
          <Row>
            <Col xs={12}>
              ...
              <select
                name="years"
                onChange={evt => this._changeYearsViewed(evt.target.value)}
              >
                  ...
                  <Accordion>
                    {race.campaigns.map((campaign, idx) => {
                      ...
                      if (scores && scores[campaign.campaign.campaignId]) {
                        let header = this._loadPanelHeader(
                          campaignData,
                          campaignID,
                          candidateName
                        );
                        ...
                        return (
                          <Panel key={idx} eventKey={idx} header={header}>
                            <CandidateInfo
                              info={scores[campaign.campaign.campaignId]}
                            />
                            <LinkContainer
