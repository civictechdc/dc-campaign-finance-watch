...
exports.getContributionById = function(contributionId) {
  return Contribution.findById(contributionId).then(function(contribution) {
...
exports.findTopContributingCompanies = function(limit, year) {
  return Contribution.aggregateAsync(
...
function populateCompanyPromise(id, amount) {
  return contributorService.findCompanyDetails(id).then(function(company) {
    var data = {};
